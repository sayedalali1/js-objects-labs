...
game.party.push(pokemon[0], pokemon[3], pokemon[6])
console.log(game.party)
...
for ( i = 0; i < pokemon.length; i++){
    if(pokemon[i].starter === true){  //copied from ex6 and mutated review if correct
        console.log(pokemon[i].name)
    }
}
console.log('---------End Exercise 9---------');
...
game.catchPokemon = function(pokemonObj) {
    ...
    game.catchPokemon(pokemon[0]);  //review to fix
    game.catchPokemon(pokemon[6]);

    console.log(game.party); 
console.log('---------End Exercise 10---------');
...
for (let i = 0; i < game.gyms.length; i++) {
    if (game.gyms[i].difficulty > 6) {
        game.gyms[i].completed = true;  //copied from ex6 needs fixing
    }
}
console.log(game.gyms);
console.log('---------End Exercise 12---------');
